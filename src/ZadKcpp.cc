...
void ZadKcpp::printMonth(mies month) {
    switch (month) {
        case styczen: std::cout << "Styczeń" << std::endl; break;
        case luty: std::cout << "Luty" << std::endl; break;
        case marzec: std::cout << "Marzec" << std::endl; break;
        case kwiecien: std::cout << "Kwiecień" << std::endl; break;
        ...
        case sierpien: std::cout << "Sierpień" << std::endl; break;
        case wrzesien: std::cout << "Wrzesień" << std::endl; break;
        case pazdziernik: std::cout << "Październik" << std::endl; break;
        case listopad: std::cout << "Listopad" << std::endl; break;
        case grudzien: std::cout << "Grudzień" << std::endl; break;
    }
}
